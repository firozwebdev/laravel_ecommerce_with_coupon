...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
            <!-- ****************** Offers Section ****************** -->
            @include('layout.front-layout.front-layout-partials.offer-section')
            ...
            @include('layout.front-layout.front-layout-partials.featured-product')

            <!-- ****************** Best Sellers Section ****************** -->
            @include('layout.front-layout.front-layout-partials.best-sold-product')
